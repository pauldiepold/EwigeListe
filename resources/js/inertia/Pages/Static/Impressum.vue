...
import StaticArticle from '@/Components/Static/StaticArticle.vue';
</script>
  ...
  <AppLayout title="Impressum">
    <StaticArticle>
      ...
      <p>
        ...
        <a href="https://www.impressum-generator.de" rel="noopener noreferrer" target="_blank">impressum-generator.de</a>
        von der
        <a href="https://www.kanzlei-hasselbach.de/" rel="noopener noreferrer" target="_blank">Kanzlei Hasselbach</a>
      </p>
    </StaticArticle>
  </AppLayout>
</template>
