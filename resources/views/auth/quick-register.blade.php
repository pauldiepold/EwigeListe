...
@section('title', 'Neuen Spieler erstellen')

@section('heading', 'Neuen Spieler erstellen')
        ...
        <div class="row justify-content-center">
            <div class="col-sm col-md-11 col-lg-8">
                <div class="alert alert-info">
                    ...
                    Hier kannst du einen neuen Spieler erstellen, ohne dass dieser sich selbst registrieren muss.
                    Wenn eine korrekte E-Mail-Adresse angegeben wird, kann er später sein Passwort zurücksetzen.
                </div>
