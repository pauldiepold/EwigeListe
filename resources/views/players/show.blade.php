...
@section('content')
    ...
    <div class="form-group">
        <h4>Statistiken für diese Gruppe anzeigen:</h4>
        <select class="form-control tw-max-w-xs tw-mx-auto tw-mb-8" name="group" id="group" onchange="location = this.value">
                ...
                <table class="table table-sm table-borderless text-left">
                    ...
                    <tr>
                        <td class="pb-2">Meiste Spiele an einem Tag:
                            <span class="small-text"><br>(am {{ date('j.n.Y', strtotime($profile->mostGamesDayDate)) }})
                            </span>
                        </td>
                    ...
                    <tr>
                        <td class="pb-2">Längste Sieges-Strähne:
                            @if( strcmp(date('j.n.Y', strtotime($profile->winStreakStart)), date('j.n.Y', strtotime($profile->winStreakEnd))) )
                                <span class="small-text"><br>({{ date('j.n', strtotime($profile->winStreakStart)) }}
                    ...
                    <tr>
                        <td class="">Längste Pech-Strähne:
                            @if( strcmp(date('j.n.Y', strtotime($profile->loseStreakStart)), date('j.n.Y', strtotime($profile->loseStreakEnd))) )
                                <span class="small-text"><br>({{ date('j.n', strtotime($profile->loseStreakStart)) }}
